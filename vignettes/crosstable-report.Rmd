...
+ You have a lot of text and a few tables? You should use [Rmarkdown](#create-reports-with-rmarkdown).
+ You have a lot of tables and little text? You should use [officer](#create-reports-with-officer).
...
See more useful functions at [https://danchaltiel.github.io/crosstable/reference/index.html#section-officer-helpers](https://danchaltiel.github.io/crosstable/reference/index.html#section-officer-helpers).
...
You can check out the result of the example above [here](https://github.com/DanChaltiel/crosstable/raw/main/examples/vignette_officer.docx).
